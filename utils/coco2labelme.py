...
class CocoDatasetHandler:
    ...
    def save_labelme(self, file_names, dirpath, save_json_only=False):
        if not os.path.exists(dirpath):
            ...
            raise ValueError(f"{dirpath} existed, Please remove it")
...
ds = CocoDatasetHandler('E:\\data\\COCO\\annotations\\kesco_instances.json', 'E:\\data\\COCO\\val2017')
ds.coco2labelme()
ds.save_labelme(ds.labelme.keys(),"label_me", True)